...
**Teorema**. Sean $X$ e $Y$ dos variables aleatorias con esperanzas $\mu_X, \, \mu_Y$ y varianzas conocidas $\sigma_X^2 , \sigma_Y^2 < \infty$. Entonces podemos afirmar que $\mu_X - \mu_Y \in (x_- , x_+)$ con una significancia $\alpha$ siendo:
